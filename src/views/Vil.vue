<template>
    ...
    <section class="dj-cont">
        ...
        <iframe class="dj" width="100%" height="280" scrolling="no" frameborder="no" allow="autoplay"  src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/1142693845&color=%23747bff&auto_play=true&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe><div style="font-size: 10px; color: #cccccc;line-break: anywhere;word-break: normal;overflow: hidden;white-space: nowrap;text-overflow: ellipsis; font-family: Interstate,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Garuda,Verdana,Tahoma,sans-serif;font-weight: 100;"><a href="https://soundcloud.com/bcco" title="BCCO" target="_blank" style="color: #cccccc; text-decoration: none;">BCCO</a> · <a href="https://soundcloud.com/bcco/bcco-premiere-vil-cravo-1st-baox14" title="BCCO Premiere: Vil &amp; Cravo - 1st [BAOX14]" target="_blank" style="color: #cccccc; text-decoration: none;">BCCO Premiere: Vil &amp; Cravo - 1st [BAOX14]</a></div>
    </section>
