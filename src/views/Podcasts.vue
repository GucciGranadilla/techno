...
<div class="content about-c">
  ...
  <div  class="hero-img-2 mb_parallax_container" id="mb_parallax_one" data-aos="fade-up" data-aos-duration="700"  data-aos-offset="500">
...
<router-link :to="{name: 'setoac'}">
  <div  class="hero-img-4 mb_parallax_container" id="mb_parallax_one" data-aos="fade-up" data-aos-duration="700"  data-aos-offset="500">
    <h1 class="hero-img-h1">SETAOC MASS</h1>
    <h2 class="hero-img-h2">March 14th</h2>
  </div>
</router-link>
  <router-link :to="{name: 'vil'}">
  <div  class="hero-img-5 mb_parallax_container" id="mb_parallax_one" data-aos="fade-up" data-aos-duration="700"  data-aos-offset="500">
    <h1 class="hero-img-h1">VIL</h1>
    <h2 class="hero-img-h2">February 1st</h2>
  </div>
</router-link>
  <h1>LOVE PARADE - 1992</h1>
