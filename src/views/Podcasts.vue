...
<div class="content about-c">
  ...
  <section class="hero">
  <router-link :to="{name: 'marron'}" data-aos="fade-up" data-aos-duration="700"  data-aos-offset="500">
  ...
  <router-link :to="{name: 'quelza'}" data-aos="fade-up" data-aos-duration="700"  data-aos-offset="500">
...
<router-link :to="{name: 'setoac'}" data-aos="fade-up" data-aos-duration="700"  data-aos-offset="500">
  ...
  <router-link :to="{name: 'vil'}" data-aos="fade-up" data-aos-duration="700"  data-aos-offset="500">
